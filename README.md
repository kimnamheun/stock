...
삼성전자 · SK하이닉스 · 현대차우 · TIGER 미국나스닥100 · TIGER 미국S&P500 실시간 주가와 USD/KRW 환율, 미국 국채 10년/5년물 수익률 그래프를 한 화면에 보여주는 대시보드입니다.
...
| 데이터 | 소스 | 갱신 주기 |
|---|---|---|
| 주가 (005930, 000660, 005385, 133690, 360750) | 네이버 금융 폴링 API (비공식) | 2초 (변동 시 전송) |
| USD/KRW 환율 | 네이버 금융 하나은행 고시환율 (비공식) | 2초 (변동 시 전송) |
...
│   └── page.tsx
├── components/
│   ├── Dashboard.tsx          # SSE 수신·국채 폴링 + 전체 레이아웃 (client)
│   ├── StockCard.tsx          # 종목 카드
│   ├── FxCard.tsx             # 환율 카드
